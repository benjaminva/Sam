...
/*
 * Clase Empresa, maneja grupos de empleados, divididos en
 * Asalariados, PorHora y Practicantes
 *
 */
 ...
 * van de 1 a 99.
 * El id del ultimo asalariados lo modifica hasta el ultimo creado.
 *
 * @param
 * @return
*/
 ...
 *
 * El id del ultimo empleado por hora lo modifica hasta el ultimo creado.
 *
 * @param
 * @return
*/
 ...
 * van del 200 al 299.
 *
 * El id del ultimo practicante lo modifica hasta el ultim creado.
 *
 * @param
 * @return
*/
 ...
 * Almacena en una variable auxiliar la suma de los salarios de cada
 * objeto mientras los recorre.
 *
 * @param
 * @return
*/
 ...
 * Almacena en una variable auxiliar la suma de los salarios de cada objeto
 ...
 * La funcion calcula el total de salarios para hacienda
 *
 * Imprime el total.
 *
 * @param
 ...
 * La funcion calcula el total de salarios incluyendo practicantes.
 *
 * Imprime el total.
 *
 * @param
